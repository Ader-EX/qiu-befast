...
app.include_router(kodelambung_routes.router, prefix="/kodelambung", tags=["Kode Lambung"], dependencies=[Depends(verify_access_token)])
app.include_router(user_routes.router, prefix="/users", tags=["Users"], dependencies=[Depends(verify_access_token)])
app.include_router(upload_routes.router, prefix="/upload", tags=["Upload"])  # No auth needed?
app.include_router(audit_routes.router, prefix="/audit-trail", tags=["Audit Trail"], dependencies=[Depends(verify_access_token)])
